...
/* og.png and shot-narrow.png sit in the immutable cache-first set, so
   the name must change whenever they are re-rendered. v7: hero line
   became 던지고, 읽으세요. */
const CACHE = 'mdview-v7';
